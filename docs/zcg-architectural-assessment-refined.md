...
Figma source for the supporting diagrams: https://www.figma.com/design/R9cVXb7xXLK6b3mCWRBhDp
...
![ZCG current-state operating model](images/figma/zcg-current-state-operating-model.png)
...
![ZCG target grants operating system architecture](images/figma/zcg-target-grants-operating-system.png)
